...
import 'package:clearance_app/modules/appointments/views/appointment_screen.dart';
import 'package:clearance_app/modules/home/views/main_screen.dart';

class IndividualClearanceScreen extends StatefulWidget {
  const IndividualClearanceScreen({super.key});

  @override
  State<IndividualClearanceScreen> createState() => _IndividualClearanceScreenState();
}
...
class _IndividualClearanceScreenState extends State<IndividualClearanceScreen> {
  ...
  Widget buildStepItem(String title, String status, IconData icon, {bool showLine = true}) {
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: statusColor.withAlpha(40), // replaces deprecated withOpacity
  ...
  void handleNextStep() async {
    final wantsCorrection = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Would you like to request a name correction before your certificate is issued?"),
        actions: [
          TextButton(
    ...
    if (wantsCorrection == true) {
      Navigator.push(context, MaterialPageRoute(builder: (_) => const NameCorrectionScreen()));
    } else {
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  buildStepItem("Finance", individualData["Finance"]!, Icons.attach_money),
                  buildStepItem("Examination", individualData["Examination"]!, Icons.school, showLine: false),
